...
if (isset($_GET['id_usuario'])) {
    ...
    $usuario_logado_id = intval($_SESSION['id_usuario']); // ID do usuário logado
...
// Verifica se o usuário logado não está visualizando seu próprio perfil
    ...
    <div class="container">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Lógica para Filmes Favoritos
                const verMaisFavoritosBtn = document.getElementById('ver-mais-favoritos-btn');
                const hiddenFavoritos = document.querySelectorAll('.hidden-movie');
                ...
                const hiddenAssistir = document.querySelectorAll('.hidden-movie');
