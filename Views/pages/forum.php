                ...
                ?>
                        <div class="topic-item">
                            ...
                            <div class="topic-stats">
                                <a href="#" data-toggle="modal" data-target="#modal_comenta_forum_<?= $forum['id_forum'] ?>">
                                    <i class="fa fa-comment"></i> <?php echo $replies['total']; ?>
                                </a>
                            </div>
                        </div>

                        <?php include '../modals/modal_comenta_forum.php'; ?>
